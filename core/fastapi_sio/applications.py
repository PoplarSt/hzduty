...
from .asyncapi import get_asyncapi
from .actors import SIOJsonEmitter, SIOEmitterMeta, SIOHandler
from .schemas.asyncapi import AsyncAPI, AsyncAPIServer
from .utils import find_cors_configuration
...
class FastAPISIO:
    ...
    def __init__(
        ...
        app: FastAPI = None,
        mount_location: str = "/sio",
        socketio_path: str = "/im/socket.io",
        async_mode: str = "asgi",
        asyncapi_url: str | None = "/sio/docs",
        version: str | None = None,
        other_asgi_app = None,
