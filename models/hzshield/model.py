...
class N01信息模板(Base):
    ...
    n11信息拟制: Mapped[List["N11信息拟制"]] = relationship(
        "N11信息拟制", back_populates="n01信息模板"
    )
...
class N11信息拟制(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["信息模板ID"], ["n01信息模板.信息模板ID"], name="template"
        ),
    ...
    n01信息模板: Mapped["N01信息模板"] = relationship(
        "N01信息模板",  back_populates="n11信息拟制"
    )
